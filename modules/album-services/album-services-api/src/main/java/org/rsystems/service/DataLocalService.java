...
public interface DataLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DataLocalServiceUtil} to access the data local service. Add custom service methods to {@link org.rsystems.service.impl.DataLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	* @return the new data
	*/
	public Data createData(int album_id);
	...
	*/
	...
	public Data deleteData(int album_id) throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Data fetchData(int album_id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Data getData(int album_id) throws PortalException;
