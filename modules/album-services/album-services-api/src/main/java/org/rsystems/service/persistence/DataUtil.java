...
public class DataUtil {
	...
	* @return the new data
	*/
	public static Data create(int album_id) {
		return getPersistence().create(album_id);
	}
	...
	*/
	public static Data remove(int album_id)
		throws org.rsystems.exception.NoSuchDataException {
		return getPersistence().remove(album_id);
	}
	...
	* @throws NoSuchDataException if a data with the primary key could not be found
	*/
	public static Data findByPrimaryKey(int album_id)
		throws org.rsystems.exception.NoSuchDataException {
		return getPersistence().findByPrimaryKey(album_id);
	}
	...
	*/
	public static Data fetchByPrimaryKey(int album_id) {
		return getPersistence().fetchByPrimaryKey(album_id);
	}
