...
package org.rsystems.service.persistence.impl;
...
import org.rsystems.model.impl.DataImpl;
import org.rsystems.model.impl.DataModelImpl;

import org.rsystems.service.persistence.DataPersistence;
 ...
 * @see DataPersistence
 * @see org.rsystems.service.persistence.DataUtil
 * @generated
 */
@ProviderType
public class DataPersistenceImpl extends BasePersistenceImpl<Data>
	...
	public Data remove(int album_id) throws NoSuchDataException {
		return remove((Serializable)album_id);
	}
	...
	protected Data toUnwrappedModel(Data data) {
		...
		dataImpl.setAlbum_id(data.getAlbum_id());
		dataImpl.setAlbum_name(data.getAlbum_name());
		dataImpl.setAlbum_path(data.getAlbum_path());
		dataImpl.setCreation_date(data.getCreation_date());
		dataImpl.setCreated_by(data.getCreated_by());
		dataImpl.setAccess(data.getAccess());
	...
	public Data findByPrimaryKey(int album_id) throws NoSuchDataException {
		return findByPrimaryKey((Serializable)album_id);
	}
	...
	public Data fetchByPrimaryKey(int album_id) {
		return fetchByPrimaryKey((Serializable)album_id);
	}
	...
	private static final String _SQL_SELECT_DATA_WHERE_PKS_IN = "SELECT data FROM Data data WHERE album_id IN (";
